...
class GameScene: SKScene {
  ...
  func addMonster() {
    ...
    // This means that the physics engine will not control the movement of the monster.
    ...
    // indicates what categories of objects this object that the physics engine handle contact responses to
